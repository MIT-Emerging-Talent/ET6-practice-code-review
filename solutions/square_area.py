...
User enters the side length and the result is the square area
...
def calculate_square_area(side_length: float) -> float:
    ...
    TypeError: if the value entered was or str or text
    ...
    if side_length <= 0:
        raise ValueError("side length must be bigger than zero")
