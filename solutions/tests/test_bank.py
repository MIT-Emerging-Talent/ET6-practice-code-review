...
def test_hello():
    ...
    This test verifies that both lowercase and uppercase 'hello' return the expected value of 0.
    """
...
def test_something():
    ...
    This test verifies that the words 'bank' and 'jungkook' both return the expected value of 100.
    """
