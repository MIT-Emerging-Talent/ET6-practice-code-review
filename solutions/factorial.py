...
def factorial(number: int) -> int:
    """The factorial function computes the factorial of a given non-negative integer.
    The factorial of a number (n!) is the result of multiplying all whole numbers
    from 1 up to number. For example, the factorial of 5 is 5 * 4 * 3 * 2 * 1 = 120.
