...
sys.path.append("../")
from ..find_largest_number import find_largest_num
...
class TestLargestNum(unittest.TestCase):
    ...
    def test_non_numeric_input(self) -> None:
        ...
        with self.assertRaises(ValueError):
            find_largest_num(["a", "b", "c"])

    def test_large_numbers(self) -> None:
        """Test case for large numbers."""
        self.assertEqual(find_largest_num([1e10, 1e15, 1e11]), 1e15)
