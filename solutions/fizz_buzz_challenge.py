...
Module contents:
    - fizz_buzz_challenge: - fizz_buzz_challenge: generates a dictionary where
    the key is the numbe and the value is the outcome of that number
...
def fizz_buzz(start: int, end: int) -> dict:
    ...
    Returns:
        ...
        of that number and the values are "Fizz", "Buzz", "FizzBuzz", or omitted
        if none apply
    Raises:
