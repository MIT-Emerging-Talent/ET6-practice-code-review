"""
This module provides function to calculate the percentage of characters in a string that match a specified letter,
...
- The letter is a single lowercase English letter.
    ...
    Raises:
        ValueError: If the string is empty or the letter is not a single lowercase English character.
