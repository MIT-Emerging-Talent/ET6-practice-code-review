...
"""
Test module for the bubble_sort function.

This file includes unittest to verify the correctness of the `bubble_sort` function. 
...
import unittest
from solutions.sort_numbers import bubble_sort


class TestBubbleSort(unittest.TestCase):
    """These unittest cases will test the bubble_sort function"""
    ...
    def test_multiple_elements_list(self):
        ...
        self.assertEqual(bubble_sort([5, 9, 4, 3, 7]), [3, 4, 5, 7, 9])

    def test_duplicate_int_list(self):
        """it should return the list with duplicates placed side by side"""
        self.assertEqual(bubble_sort([7, 7, 1, 2, 9]), [1, 2, 7, 7, 9])

    def test_range_int_10_99(self):
        """it should return the list of integers from smallest to largest"""
        self.assertEqual(
            bubble_sort([95, 12, 54, 76, 87, 18, 33, 60]),
    ...
    def test_negative_int_list(self):
        ...
        self.assertEqual(
            bubble_sort([-3, -54, -1, -9, -23, -99, -12, -34]),
    ...
    def test_mixed_of_positive_and_negative_int_list(self):
        ...
        self.assertEqual(bubble_sort([11, -43, -36, 5, 43]), [-43, -36, 5, 11, 43])
    ...
    def test_zero_with_positive_int_list(self):
        ...
        self.assertEqual(
            bubble_sort([16, 44, 0, 23, 555, 3, 200, 101]),
    ...
    def test_large_range_int_list(self):
        ...
        self.assertEqual(
            bubble_sort([35236, 555555, 98732145, 100, 7543, 894521, 99991200]),
