...
# -*- coding: utf-8 -*-
"""
Test module for check_credit_card function.
...
from solutions.check_credit_card import check_credit_card


class TestCheckCreditCard(unittest.TestCase):
    """Test suite for the check_credit_card function."""

    # Standard test cases
    def test_amex_1(self):
        """A standard test case for an 'AMEX' card"""
        card_number = "378282246310005"
        self.assertEqual(check_credit_card(card_number), "AMEX")
    ...
    def test_mastercard_1(self):
        ...
        self.assertEqual(check_credit_card(card_number), "MASTERCARD")
    ...
    def test_visa_1(self):
        ...
        self.assertEqual(check_credit_card(card_number), "VISA")
    ...
    def test_invalid_1(self):
        ...
        self.assertEqual(check_credit_card(card_number), "INVALID")
