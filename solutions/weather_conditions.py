"""
A module for getting weather condition

Module contents: Takes temperature and return the weather condition.
...
def get_weather_condition(temperature):
    """
    Determines the weather condition based on temperature in Celsius.ma
