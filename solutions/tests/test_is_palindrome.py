...
class TestIsPalindrome(unittest.TestCase):
    ...
    def test_function_is_callable(self):
        ...
        is_palindrome("madam")  # Simply calling the function to check if it's callable

    def test_palindrome_string(self):
        """it should return True if you pass a palindrome string."""
        actual = is_palindrome("radar")
        self.assertEqual(actual, True)  # "radar" is a palindrome

    def test_non_palindrome_string(self):
        """it should return False if you pass a non-palindrome string."""
        actual = is_palindrome("hello")
        self.assertEqual(actual, False)  # "hello" is not a palindrome
    ...
    def test_ignore_spaces_and_punctuation(self):
        ...
        self.assertEqual(actual, True)  # Spaces and punctuation ignored
    ...
    def test_palindrome_with_heavy_punctuation(self):
        ...
        self.assertEqual(
            actual, True
        )  # Spaces and punctuation ignored, it's a palindrome
    ...
    def test_non_palindrome_with_heavy_punctuation(self):
        ...
        self.assertEqual(
            actual, False
        )  # Spaces and punctuation ignored, it's not a palindrome

    def test_empty_string(self):
        """it should return False if you pass an empty string"""
        actual = is_palindrome("")
        self.assertEqual(actual, False)  # An empty string is not a palindrome
    ...
    def test_single_space(self):
        ...
        self.assertEqual(
            actual, False
        )  # A string with just one space is not a palindrome

    def test_multiple_spaces(self):
        """it should return False if you pass a string containing multiple spaces"""
        actual = is_palindrome(
            "   "
        )  # Three spaces, but any number of spaces should return False
        self.assertEqual(actual, False)  # A string with only spaces is not a palindrome

    def test_single_character(self):
        """it should return True if you pass a single character"""
        actual = is_palindrome("a")
        self.assertEqual(actual, True)  # A single character is a palindrome
    ...
    def test_two_identical_characters(self):
        ...
        self.assertEqual(actual, True)  # Two identical characters is a palindrome
    ...
    def test_two_different_characters(self):
        ...
        self.assertEqual(actual, False)  # Two different characters is not a palindrome

    def test_case_insensitivity(self):
        """it should be case insensitive when the text is upper"""
        actual = is_palindrome("Level")
        self.assertEqual(actual, True)  # "Level" is the same as "level"
