...
from housing_prices_analysis_solution import (
    load_data,
    preprocess_data,
    analyze_data,
    train_model,
...
class TestHousingAnalysis(unittest.TestCase):
    ...
    def test_preprocess_data(self):
        ...
        self.assertEqual(
            processed_data.shape, self.data.shape
        )  # No missing values in the initial dataset
    ...
    def test_train_model(self):
        ...
        self.assertTrue(
            any(model.coef_ != 0), "Model coefficients should not all be zero."
        )
    ...
    def test_evaluate_model(self):
        ...
        self.assertGreaterEqual(
            r2, -1, "R-squared should be greater than or equal to -1."
        )
